        ...
        <div className='my-container'>
            ...
            <div className='grid md:grid-cols-3 lg:grid-cols-5 gap-3 mt-14'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <h3 className='mt-3 text-slate-600 text-lg font-semibold'>Vegetarian</h3>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <div className='relative transform hover:rotate-12 hover:scale-100 transition-transform duration-700 ease-in-out'>
                    ...
                    <h3 className='mt-3 text-slate-600 text-lg font-semibold'>Beef</h3>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <div className='relative transform hover:rotate-12 hover:scale-100 transition-transform duration-700 ease-in-out'>
                    ...
                    <h3 className='mt-3 text-slate-600 text-lg font-semibold'>Chicken</h3>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <div className='relative transform hover:rotate-12 hover:scale-100 transition-transform duration-700 ease-in-out'>
                    ...
                    <h3 className='mt-3 text-slate-600 text-lg font-semibold'>Appetizers</h3>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <div className='relative transform hover:rotate-12 hover:scale-100 transition-transform duration-700 ease-in-out'>
                    ...
                    <h3 className='mt-3 text-slate-600 text-lg font-semibold'>Desserts</h3>
                </div>
